...
export default function SearchBar({ onSearch }) {
  return (
    <div className="flex flex-wrap gap-2 md:gap-4 max-w-4xl w-full md:mx-auto bg-white/10 backdrop-blur-md p-2 md:p-4 rounded-2xl">
      ...
      <button className="bg-gradient-to-r from-g-purple to-g-purple-light text-white px-8 py-3 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 w-full sm:w-32">
        Search
      </button>
    </div>
  );
